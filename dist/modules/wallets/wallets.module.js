...
exports.WalletsModule = WalletsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([wallet_entity_1.Wallet, hold_entity_1.Hold]), ledger_module_1.LedgerModule],
        controllers: [wallets_controller_1.WalletsController],
        providers: [wallet_service_1.WalletService],
        exports: [typeorm_1.TypeOrmModule, wallet_service_1.WalletService],
    })
], WalletsModule);
